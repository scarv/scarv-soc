...
#
# Reads all of the sources for the design to be synthesised
#
...
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/p_addsub/p_addsub.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/p_shfrot/p_shfrot.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/xc_sha3/xc_sha3.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/xc_sha256/xc_sha256.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/xc_aessub/xc_aessub.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/xc_aessub/xc_aessub_sbox.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/xc_aesmix/xc_aesmix.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/xc_malu/xc_malu.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/xc_malu/xc_malu_divrem.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/xc_malu/xc_malu_long.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/xc_malu/xc_malu_mul.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/xc_malu/xc_malu_pmul.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/xc_malu/xc_malu_muldivrem.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/b_bop/b_bop.v
read_verilog $::env(SOC_HOME)/extern/scarv-cpu/external/xcrypto/rtl/b_lut/b_lut.v
